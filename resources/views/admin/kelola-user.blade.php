                ...
                <div class="table-responsive container">
                    <table class="table-style" style="width: 100%;">
                        ...
                        <tr class="table-content">
                            ...
                            <td>
                                @if((($val->role->nama_role == 'pengunjung' || $val->role->nama_role == 'admin' || $val->role->nama_role == 'author') &&
                                ...
                                @if(($val->role->nama_role == 'pengunjung' || $val->role->nama_role == 'author') &&
                                App\Models\Role::find(Auth::user()->role_id)->nama_role == 'admin')
                                ...
                                @elseif (App\Models\Role::find(Auth::user()->role_id)->nama_role == 'super_admin')
                                    ...
                                    {{-- Kalau dia super admin, dia tidak bisa dihapus --}}
                                    @if ($val->role->nama_role != 'super_admin')
