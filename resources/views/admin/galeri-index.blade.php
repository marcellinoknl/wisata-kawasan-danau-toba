...
@if ($katGaleri == null)
    <div class="alert alert-primary">
        <h4><strong class="alert-font">Maaf, <label for="" class="text-secondary">Kategori Galeri belum ditambahkan.</label> Mohon tambahkan di halaman kategori Galeri, atau klik link <a href="{{url('/kelola-kat-galeri')}}"><label for="" class="text-primary">ini</label></a></strong></h4>
    </div>
@else
<div class="row">
